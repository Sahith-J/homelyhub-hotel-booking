...
const Header = () => {
  ...
  return (
    <>
      <nav
        className="row sticky-top m-auto d-flex justify-content-around align-items-center "
        style={{
          width: "100%",
          height: "90px",
        }}
      >
        ...
        <div
          className="search_filter rounded-pill h-50 d-flex align-items-center justify-content-around "
