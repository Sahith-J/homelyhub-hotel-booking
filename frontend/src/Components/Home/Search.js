...
const Search = () => {
  ...
  return (
    <>
      <div
        className="searchbar pl-2 d-flex align-items-center rounded rounded-pill h-100"
        style={{ width: "90%" }}
      >
        <input
          className="form-control col-sm-4 rounded rounded-pill text-light"
        ...
        />
        <input
          className="form-control col-sm-2 rounded rounded-pill  text-light"
          style={{ border: "transparent" }}
          id="addquest"
        ...
        <Space direction="verticle" size={12}>
          <RangePicker
            ...
            format="YYYY-MM-DD"
            picker="date"
            className="date_picker form-control col-12 d-flex rounded rounded-pill fs-2  text-dark"
