...
const Card = ({ id, image, address, price, name }) => {
  return (
    <figure className="property w-100">
      ...
      <p
        className="card-footer text-light text-center fs-6"
...
const PropertyList = () => {
  ...
  return (
    <>
      ...
      {/* Pagination Control */}
      <div className=" p-5 d-flex justify-content-around pagination-btn">
        <button
        ...
        <p className="text-dark">Page: {currentPage.page}</p>
